...
Actions performed:
  ...
  - Inserts transformed and cleansed data from Bronze sinto Silver tables
...
BEGIN TRY
    SET @start_load = GETDATE();
        ...
        PRINT 'Total load time: '+CAST(DATEDIFF(second, @start_load, @end_load)AS NVARCHAR) + ' seconds.';
